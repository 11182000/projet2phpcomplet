...
<body>
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="code du client" name="codecl">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="p-t-20">
                            <input class="btn btn--radius btn--green" type="submit" value="Modifier" name="Modifier"><br><br><br>
                        </div>
                    </form>
                    <div class="input-group">
    ...
    <?php
        ...
        if(isset($_POST)){
            ...
            $req="update client set nomcl='$nomcl',prenomcl='$prenomcl',adressecl='$adressecl' where codecl='$codecl'";  
